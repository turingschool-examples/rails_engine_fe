...
RSpec.describe StoreService do
  ...
  describe '#merchant()' do
    it 'returns a singe merchant' do
      ...
      expect(response[:data].keys.sort).to eq(%i[id type attributes].sort)
  ...
  describe '#item()' do
    it 'returns a single item' do
      ...
      expect(response[:data][:attributes].keys.sort).to eq(%i[name description unit_price merchant_id].sort)
      expect(response[:data][:attributes][:name]).to be_a String
